(function(){'use strict';
function key(){var d=document.body&&document.body.dataset?document.body.dataset.handbookDestination||'guide':'guide';return'travel-handbook-theme-v2:'+String(d).toLowerCase()}
var themes=[
  {id:'winter',name:'冬雪蓝',note:'二月与雪山',swatch:'#7893a2'},
